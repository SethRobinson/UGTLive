...
REM -----------------------------------------------------------------
REM Install PyTorch 2.6+ from nightly (required for Manga OCR)
REM -----------------------------------------------------------------
echo.
echo Installing PyTorch 2.6+ (required for Manga OCR security fix)...
echo Note: Using nightly build as stable 2.6 not yet available

REM Install packages individually to avoid version conflicts
...
python -m pip install --pre torchvision --index-url https://download.pytorch.org/whl/nightly/cu121
python -m pip install --pre torchaudio --index-url https://download.pytorch.org/whl/nightly/cu121
