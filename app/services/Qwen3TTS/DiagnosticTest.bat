...
python -c "from faster_qwen3_tts import FasterQwen3TTS; print('    faster-qwen3-tts imported successfully')" 2>nul
if errorlevel 1 (
    echo   [FAIL] faster-qwen3-tts import failed
    goto :TestFail
)

echo   - Testing soundfile...
python -c "import soundfile; print('    soundfile version:', soundfile.__version__)" 2>nul
if errorlevel 1 (
    echo   [FAIL] soundfile import failed
    goto :TestFail
)
